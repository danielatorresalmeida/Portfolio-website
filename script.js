...
const TRANSLATIONS = {
  ...
  "hero.lead": "I build web interfaces and APIs with React, TypeScript and Java/Spring Boot, drawing on practical startup experience and ongoing Software Development training.",
  ...
  "hero.highlights.1.title": "Training in progress",
  "hero.highlights.1.text": "650 hours of technical Software Development training.",
  "hero.highlights.2.title": "Next step · 2027",
  "hero.highlights.2.text": "400-hour curricular internship, expected February/March, with interest in continuing as a Junior Developer.",
  ...
  "contact.intro": "Let’s discuss a 400-hour Software Development curricular internship expected to start in February/March 2027, and the possibility of continuing as a Junior Developer if it is a good fit for both sides.",
  ...
  "projects.penguin.contribution": "Implemented a modular C game with explicit state, input validation and progression across sessions.",
  ...
  "training.developing.body": "Deepening software development through the current training programme and practical web projects.",
  "training.expected.title": "Expected before internship",
  "training.expected.body": "Completion of the 650-hour technical component before applying that learning in a 400-hour curricular internship.",
  ...
  "hero.title": "Daniela Torres Almeida",
  "hero.lead": "Desenvolvo interfaces web e APIs com React, TypeScript e Java/Spring Boot, com experiência prática numa startup e formação em Software Development em curso.",
  ...
  "hero.highlights.1.title": "Formação em curso",
  "hero.highlights.1.text": "650 horas de formação técnica em Software Development.",
  "hero.highlights.2.title": "Próxima etapa · 2027",
  "hero.highlights.2.text": "Estágio curricular de 400 horas, previsto para fevereiro/março, com interesse em continuidade como Junior Developer.",
  ...
  "contact.intro": "Podemos conversar sobre um estágio curricular de 400 horas em Software Development, com início previsto para fevereiro/março de 2027, e sobre a possibilidade de continuidade como Junior Developer se houver interesse mútuo.",
  "contact.actions.email": "Email",
  "contact.actions.linkedin": "LinkedIn",
  ...
  "projects.penguin.contribution": "Implementei um jogo modular em C com estado explícito, validação de input e progressão entre sessões.",
  "projects.penguin.feature.0": "Lógica de jogo modular",
  "projects.penguin.feature.1": "Input de terminal validado",
  "projects.penguin.feature.2": "Estado e progressão entre sessões",
  ...
  "training.description": "A frequentar uma formação de Software Development com 650 horas de componente técnica, seguida de um estágio curricular de 400 horas com início previsto para fevereiro/março de 2027.",
  ...
  "training.developing.body": "A aprofundar desenvolvimento de software através da formação atual e de projetos web práticos.",
  "training.expected.title": "Previsto antes do estágio",
  "training.expected.body": "Conclusão da componente técnica de 650 horas antes de aplicar essa aprendizagem num estágio curricular de 400 horas.",
