...
const TRANSLATIONS = {
  ...
  "hero.highlights.1.title": "Next training programme",
  "hero.highlights.1.text": "CESAE Digital · Software Developer · starts 22 September 2026.",
  ...
  "about.story": "After working in music education, hospitality and language-related work, I moved into software development and gained practical experience in a technology startup. I completed the IEFP Java programming pathway in July 2026 and build React/TypeScript and Java/Spring projects. UI/UX supports my implementation and usability decisions. My next step is the CESAE Digital Software Developer programme, starting on 22 September 2026, with a curricular internship from 1 March to 20 May 2027 and the goal of progressing to a Junior Developer role.",
  "training.description": "Software Developer · CESAE Digital · PRO_MOV by Reskilling4Employment. Scheduled: 22 Sep 2026 - 20 May 2027. 1050h total: 50h transversal skills, 600h technical training and 400h FPCT (curricular internship), scheduled for 1 Mar - 20 May 2027.",
  ...
  "hero.highlights.1.title": "Próxima formação",
  "hero.highlights.1.text": "CESAE Digital · Software Developer · início em 22 de setembro de 2026.",
  ...
  "about.story": "Depois de trabalhar em educação musical, hotelaria e tarefas linguísticas, passei para o desenvolvimento de software e adquiri experiência prática numa startup tecnológica. Concluí o percurso IEFP de programação em Java em julho de 2026 e desenvolvo projetos React/TypeScript e Java/Spring. UI/UX complementa as decisões de implementação e usabilidade. A próxima etapa é o programa Software Developer do CESAE Digital, com início em 22 de setembro de 2026, estágio curricular de 1 de março a 20 de maio de 2027 e objetivo de progressão para Junior Developer.",
  "training.description": "Software Developer · CESAE Digital · PRO_MOV by Reskilling4Employment. Início previsto: 22 set 2026; conclusão: 20 mai 2027. 1050h no total: 50h de competências transversais, 600h de formação técnica e 400h de FPCT (estágio curricular), prevista para 1 mar - 20 mai 2027.",
