...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "projects.tictactoe.status": "Playable demo available",
    "projects.tictactoe.title": "Tic-Tac-Toe Game in C",
    "projects.tictactoe.summary": "Console-based C project with a browser-playable portfolio demo.",
    "projects.tictactoe.what": "A console-based Tic-Tac-Toe game developed in C, with configurable rules, computer modes, tournaments, save/load, replay, ranking, automatic tests, and a GitHub Pages browser demo for portfolio visitors.",
    "projects.tictactoe.logic": "<strong>Focus:</strong> Game rules, win/draw checks, player turns, terminal interaction, and accessible color UI.",
    "projects.tictactoe.learning": "<strong>Learning:</strong> Modular C, file handling, tests, JavaScript web porting, and GitHub Pages deployment.",
    "projects.tictactoe.proof": "Skills shown: C, modular structure, game logic, terminal UI, automated tests, JavaScript, and GitHub Pages.",
  ...
  [LANG_PT]: {
    ...
    "projects.tictactoe.status": "Demonstração jogável disponível",
    "projects.tictactoe.title": "Jogo do Galo em C",
    "projects.tictactoe.summary": "Projeto de consola em C com demonstracao jogavel no browser para o portfolio.",
    "projects.tictactoe.what": "Jogo do Galo em consola desenvolvido em C, com regras configuraveis, modos de computador, torneios, gravar/carregar, replay, ranking, testes automaticos e uma demonstracao no GitHub Pages para visitantes do portfolio.",
    "projects.tictactoe.logic": "<strong>Foco:</strong> Regras do jogo, verificacao de vitoria/empate, turnos de jogador, interacao no terminal e UI com cores acessiveis.",
    "projects.tictactoe.learning": "<strong>Aprendizagem:</strong> C modular, ficheiros, testes, adaptacao para JavaScript e publicacao no GitHub Pages.",
    "projects.tictactoe.proof": "Competencias: C, estrutura modular, logica de jogo, UI de terminal, testes automaticos, JavaScript e GitHub Pages.",
