...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "about.technical.tools.8": "Pytest",
    "about.technical.tools.9": "pytest-html",
    "about.technical.tools.10": "Selenium",
    "about.technical.tools.11": "Vercel",
    "about.technical.backend.title": "QA & Testing",
    "about.technical.backend.0": "SQL / Database Design",
    ...
    "strengths.0": "Responsive frontend engineering with React, TypeScript, and Next.js",
    "strengths.1": "UI/UX execution from Figma to production-ready interfaces",
    "strengths.2": "Accessibility-first components and semantic HTML structure",
    "strengths.3": "QA-oriented workflow with manual, API, and debugging checks",
    "strengths.4": "Selenium smoke and regression automation for critical user journeys",
    "strengths.5": "CI-ready delivery with GitHub Actions and deploy safety gates",
  ...
  [LANG_PT]: {
    ...
    "about.technical.tools.10": "Selenium",
    "about.technical.tools.11": "Vercel",
    "about.technical.backend.title": "QA e Testes",
    "about.technical.backend.0": "SQL / Design de Base de Dados",
    ...
    "strengths.0": "Engenharia frontend responsiva com React, TypeScript e Next.js",
    "strengths.1": "Execução UI/UX de Figma para interfaces prontas para produção",
    "strengths.2": "Componentes orientados à acessibilidade e estrutura semântica em HTML",
    "strengths.3": "Fluxo orientado para QA com validações manuais, API e debugging",
    "strengths.4": "Automação de smoke e regression tests com Selenium em jornadas críticas",
    "strengths.5": "Entrega orientada a CI com GitHub Actions e bloqueios de segurança no deploy",
