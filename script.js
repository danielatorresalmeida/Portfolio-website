...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "hero.lead": "Junior software development candidate exploring IT opportunities, especially junior frontend, software development, web development, and QA/testing roles. I bring a background in arts and music education, plus creativity, attention to detail, adaptability, and practical project experience.",
    "hero.cta.work": "View Projects",
    "hero.cta.resume": "View Resume",
    "hero.cta.contact": "Contact Me",
    "hero.highlights.0.title": "Junior IT focus",
    "hero.highlights.0.text": "Open to junior frontend, web development, software development, and QA/testing roles.",
    ...
    "coreStack.frontend.5": "Responsive Web Design",
    "coreStack.frontend.6": "REST API Integration",
    ...
    "coreStack.4": "Angular",
    "coreStack.5": "Responsive Web Design",
    "coreStack.6": "REST API Integration",
    "coreStack.7": "UI/UX Design",
    "coreStack.8": "Figma",
    "coreStack.9": "C",
    "coreStack.10": "Java",
    "coreStack.11": "Python Basics",
    "coreStack.12": "Git / GitHub",
    "coreStack.13": "QA Concepts",
    ...
    "projects.tictactoe.what": "A console-based Tic-Tac-Toe game developed in C, focused on programming logic, condition checking, user interaction, loops, functions, and structured problem-solving.",
    "projects.tictactoe.logic": "<strong>Focus:</strong> Game rules, win/draw checks, player turns, and terminal interaction.",
    "projects.tictactoe.learning": "<strong>Learning:</strong> Functions, loops, conditionals, debugging, and clearer code structure.",
    "projects.tictactoe.proof": "Skills shown: C, logic, terminal interaction, functions, loops, conditionals, debugging.",
    ...
    "about.technical.frontend.6": "REST API Integration",
    ...
    "contact.intro": "Hiring for a junior frontend or Vue-oriented web development role? Let's discuss how I can support your team.",
  ...
  [LANG_PT]: {
    ...
    "hero.lead": "Candidata junior em desenvolvimento de software a explorar oportunidades em IT, especialmente em frontend junior, desenvolvimento de software, desenvolvimento web e QA/testes. Trago um percurso em artes e educacao musical, criatividade, atencao ao detalhe, adaptabilidade e experiencia pratica em projetos.",
    "hero.cta.work": "Ver projetos",
    "hero.cta.resume": "Ver CV",
    "hero.cta.contact": "Contactar",
    "hero.highlights.0.title": "Foco junior em IT",
    "hero.highlights.0.text": "Aberta a funcoes junior em frontend, desenvolvimento web, desenvolvimento de software e QA/testes.",
    ...
    "coreStack.frontend.3": "TypeScript",
    "coreStack.frontend.4": "Angular",
    "coreStack.frontend.5": "Design Web Responsivo",
    "coreStack.frontend.6": "Integracao com REST API",
    "coreStack.design.title": "Design / UI",
    ...
    "coreStack.3": "TypeScript",
    "coreStack.4": "Angular",
    "coreStack.5": "Design Web Responsivo",
    "coreStack.6": "Integracao com REST API",
    "coreStack.7": "Design UI/UX",
    "coreStack.8": "Figma",
    "coreStack.9": "C",
    "coreStack.10": "Java",
    "coreStack.11": "Bases de Python",
    "coreStack.12": "Git / GitHub",
    "coreStack.13": "Conceitos de QA",
    ...
    "projects.tictactoe.what": "Jogo do Galo em consola desenvolvido em C, focado em logica de programacao, verificacao de condicoes, interacao com o utilizador, ciclos, funcoes e resolucao estruturada de problemas.",
    "projects.tictactoe.logic": "<strong>Foco:</strong> Regras do jogo, verificacao de vitoria/empate, turnos de jogador e interacao no terminal.",
    "projects.tictactoe.learning": "<strong>Aprendizagem:</strong> Funcoes, ciclos, condicionais, debugging e estrutura de codigo mais clara.",
    "projects.tictactoe.proof": "Competencias: C, logica, interacao no terminal, funcoes, ciclos, condicionais, debugging.",
    ...
    "about.technical.frontend.4": "TypeScript",
    "about.technical.frontend.5": "Angular",
    "about.technical.frontend.6": "Integracao com REST API",
    "about.technical.design.title": "UI/UX",
    ...
    "contact.intro": "Está a contratar para uma função júnior de frontend ou desenvolvimento web orientado a Vue? Vamos conversar sobre como posso contribuir para a sua equipa.",
    "contact.actions.email": "Email",
    "contact.actions.linkedin": "LinkedIn",
