...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "strengths.3": "Data and database engineering with SQL fundamentals, database access technologies, and PostgreSQL data modeling.",
    "strengths.4": "Java and backend development using Java fundamentals, Java web application development, and Python tooling.",
    "strengths.5": "Software engineering and delivery with algorithms, C/C++ fundamentals, development methodologies, and Git-based release workflows.",
  ...
  [LANG_PT]: {
    ...
    "strengths.3": "Engenharia de dados e bases de dados com fundamentos de SQL, tecnologias de acesso a base de dados e modelação em PostgreSQL.",
    "strengths.4": "Desenvolvimento Java e backend com fundamentos de Java, desenvolvimento web em Java e ferramentas Python.",
    "strengths.5": "Engenharia de software e entrega com algoritmos, fundamentos de C/C++, metodologias de desenvolvimento e fluxos de release com Git.",
