...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "hero.highlights.2.title": "Project context",
    "hero.highlights.2.text": "Each project connects planning, implementation, testing, and continuous improvement.",
    ...
    "projects.featured.overview": "<strong>Overview:</strong> Implemented React / TypeScript and Java / Spring Boot application for project and task management with PostgreSQL.",
    ...
    "projects.featured.result": "<strong>Current result:</strong> Academic version delivered in July 2026, with authentication, role logic, tests and CI; further hardening remains on the roadmap.",
    ...
    "projects.penguinFishing.overlay": "Terminal fishing gameplay with ncurses colors, keyboard controls, timed rounds, and local multiplayer.",
    "projects.penguinFishing.status": "Terminal C project",
    "projects.penguinFishing.title": "Penguin Fishing Game",
    "projects.penguinFishing.summary": "Modular terminal fishing game with nine modes, bilingual menus, and one- or two-player gameplay.",
    "projects.penguinFishing.what": "A final course project adapted from an original Scratch prototype into a modular C terminal game where penguins catch fish using directional hooks.",
    "projects.penguinFishing.mainTool": "<strong>Main tool:</strong> C",
    "projects.penguinFishing.secondary": "<strong>Also uses:</strong> ncurses, Makefile, MSYS2 UCRT64, GCC, and optional SoX sound.",
    "projects.penguinFishing.demonstrates": "<strong>What it demonstrates:</strong> Modular C architecture, game-state logic, validated keyboard input, scoring systems, and terminal UI design.",
    "projects.penguinFishing.features": "<strong>Main features:</strong> Nine solo, two-player, and practice modes; fish-count, weight, and stacking objectives; bilingual menus; rotating hooks; pause; replay; and sound controls.",
    "projects.penguinFishing.learning": "<strong>Tech stack:</strong> C, ncurses, Makefile, MSYS2 UCRT64, GCC.",
    "projects.penguinFishing.proof": "Tech stack: C, ncurses, Makefile, MSYS2 UCRT64, GCC.",
    "projects.nextpath.status": "Academic version delivered · July 2026",
    ...
    "projects.nextpath.summary": "Implemented full-stack project and task management application.",
    "projects.nextpath.what": "Delivered with a React + TypeScript frontend, Java / Spring Boot REST API and PostgreSQL. The implementation includes authentication, role and permission logic, project/task workflows, automated tests and CI.",
    "projects.nextpath.mainTool": "<strong>Main stack:</strong> React + TypeScript + Vite (frontend), Java + Spring Boot (backend), PostgreSQL",
    "projects.nextpath.secondary": "<strong>Also uses:</strong> Spring Security, backend and frontend tests, and GitHub Actions CI.",
    ...
    "projects.nextpath.implementation": "<strong>Implemented:</strong> React views connected to the REST API, authentication, project/task workflows and role/permission checks.",
    "projects.nextpath.outcome": "<strong>Delivered version:</strong> The July 2026 academic submission is available in the repository, with tests and CI. No public live demo is currently offered.",
    "projects.nextpath.next": "<strong>Future work:</strong> Complete document authorization, improve demonstration seed data, deployment and accessibility. These are not claimed as completed.",
    ...
    "projects.qa.overlay": "One ReqRes smoke test with Python, pytest and an HTML report.",
    "projects.qa.title": "API QA Test Suite",
    "projects.qa.summary": "Single-endpoint smoke test checking HTTP 200, a JSON object and the data key.",
    "projects.qa.what": "What I did: Built a reusable HTTP client and one GET /users smoke test. It checks status 200, JSON object type and the data key; it does not validate schemas or business rules.",
    ...
    "projects.qa.demonstrates": "<strong>What it demonstrates:</strong> Basic API assertions, environment configuration, report generation and CI failure handling.",
    "projects.qa.problem": "<strong>Scope:</strong> Verify the basic response shape of one endpoint.",
    "projects.qa.solution": "<strong>Implementation:</strong> Python Requests, one pytest smoke test and pytest-html reporting.",
    "projects.qa.outcome": "<strong>Evidence:</strong> The audited report had 0 passed / 1 skipped. A ReqRes API key is required for live validation; consult the latest report and CI result.",
    ...
    "projects.actions.source": "View Source",
    ...
    "skillsMap.frontend.2": "<strong>JavaScript/TypeScript:</strong> Portfolio interactions, DevFlow Hub frontend and To-Do App",
    ...
    "about.technical.frontend.8": "Vue.js (learning)",
    ...
    "courses.intro": "Recent coursework organized by learning track: QA, web foundations, programming, Java, databases, software engineering, and projects.",
    ...
    "courses.5": "Programming Foundations: C/C++ Programming - Fundamentals - IEFP Certification (Jun 2026)",
    "courses.6": "Java Development: Java Programming - IEFP Certification (Mar 2026)",
    "courses.7": "Java Development: Java Language Fundamentals - IEFP Certification (May 2026)",
    "courses.8": "Java Development: Web Application Development in Java - IEFP Certification (Jul 2026)",
    "courses.9": "Databases: SQL Language Fundamentals - IEFP Certification (Mar 2026)",
    "courses.10": "Databases: Database Access Technologies - IEFP Certification (Apr 2026)",
    "courses.11": "Software Engineering: Software Engineering - IEFP Certification (Jun 2026)",
    "courses.12": "Software Engineering: Software Development Methodologies - IEFP Certification (Jun 2026)",
    "courses.13": "Projects: Programming Project - IEFP Certification (Jul 2026)",
    "courses.14": "Projects: Information Systems Technologies and Programming Project - IEFP Certification (Jul 2026)",
  ...
  [LANG_PT]: {
    ...
    "hero.highlights.2.title": "Contexto dos projetos",
    "hero.highlights.2.text": "Cada projeto liga planeamento, implementacao, testes e melhoria continua.",
    ...
    "projects.featured.title": "DevFlow Hub",
    "projects.featured.overview": "<strong>Visão geral:</strong> Aplicação implementada em React / TypeScript e Java / Spring Boot para gestão de projetos e tarefas com PostgreSQL.",
    ...
    "projects.featured.result": "<strong>Resultado atual:</strong> Versão académica entregue em julho de 2026, com autenticação, lógica de funções, testes e CI; melhorias adicionais permanecem no roadmap.",
    ...
    "projects.penguinFishing.overlay": "Jogo de pesca em terminal com cores ncurses, controlos de teclado, rondas cronometradas e multijogador local.",
    "projects.penguinFishing.status": "Projeto de terminal em C",
    "projects.penguinFishing.title": "Penguin Fishing Game",
    "projects.penguinFishing.summary": "Jogo de pesca modular em terminal com nove modos, menus bilingues e partidas para um ou dois jogadores.",
    "projects.penguinFishing.what": "Projeto final da unidade curricular, adaptado de um prototipo original em Scratch para um jogo modular de terminal em C onde pinguins apanham peixes com anzois direcionais.",
    "projects.penguinFishing.mainTool": "<strong>Ferramenta principal:</strong> C",
    "projects.penguinFishing.secondary": "<strong>Tambem usa:</strong> ncurses, Makefile, MSYS2 UCRT64, GCC e som opcional com SoX.",
    "projects.penguinFishing.demonstrates": "<strong>O que demonstra:</strong> Arquitetura modular em C, logica de estado do jogo, input de teclado validado, sistemas de pontuacao e design de interface em terminal.",
    "projects.penguinFishing.features": "<strong>Funcionalidades principais:</strong> Nove modos solo, dois jogadores e pratica; objetivos por numero, peso e pilha de peixes; menus bilingues; anzois rotativos; pausa; replay e controlo de som.",
    "projects.penguinFishing.learning": "<strong>Stack:</strong> C, ncurses, Makefile, MSYS2 UCRT64, GCC.",
    "projects.penguinFishing.proof": "Stack: C, ncurses, Makefile, MSYS2 UCRT64, GCC.",
    "projects.nextpath.status": "Versão académica entregue · julho de 2026",
    ...
    "projects.nextpath.title": "DevFlow Hub",
    "projects.nextpath.summary": "Aplicação full-stack implementada para gestão de projetos e tarefas.",
    "projects.nextpath.what": "Entregue com frontend React + TypeScript, API REST Java / Spring Boot e PostgreSQL. Inclui autenticação, lógica de funções e permissões, gestão de projetos e tarefas, testes automatizados e CI.",
    ...
    "projects.nextpath.secondary": "<strong>Também usa:</strong> Spring Security, testes de backend e frontend e CI com GitHub Actions.",
    ...
    "projects.nextpath.implementation": "<strong>Implementado:</strong> Vistas React ligadas à API REST, autenticação, gestão de projetos/tarefas e verificações de funções/permissões.",
    "projects.nextpath.outcome": "<strong>Versão entregue:</strong> A entrega académica de julho de 2026 está disponível no repositório, com testes e CI. Atualmente não é disponibilizada uma demo pública online.",
    "projects.nextpath.next": "<strong>Trabalho futuro:</strong> Completar a autorização de documentos e melhorar dados de demonstração, deployment e acessibilidade. Estes pontos não são apresentados como concluídos.",
    ...
    "projects.qa.overlay": "Um smoke test ReqRes com Python, pytest e relatório HTML.",
    "projects.qa.title": "Suite de Testes de API (QA)",
    "projects.qa.summary": "Smoke test de um endpoint que verifica HTTP 200, um objeto JSON e a chave data.",
    "projects.qa.what": "O que fiz: Criei um cliente HTTP reutilizável e um smoke test GET /users. Verifica estado 200, tipo de objeto JSON e chave data; não valida schemas nem regras de negócio.",
    ...
    "projects.qa.demonstrates": "<strong>O que demonstra:</strong> Assertions básicas de API, configuração por ambiente, geração de relatórios e tratamento de falhas em CI.",
    "projects.qa.problem": "<strong>Âmbito:</strong> Verificar a estrutura básica da resposta de um endpoint.",
    "projects.qa.solution": "<strong>Implementação:</strong> Python Requests, um smoke test pytest e relatório pytest-html.",
    "projects.qa.outcome": "<strong>Evidência:</strong> O relatório auditado tinha 0 passed / 1 skipped. A validação real requer uma chave ReqRes; consultar o relatório e o resultado CI mais recentes.",
    ...
    "projects.actions.source": "Ver código",
    ...
    "skillsMap.frontend.2": "<strong>JavaScript/TypeScript:</strong> Interações do portfolio, frontend DevFlow Hub e aplicação To-Do",
    ...
    "about.technical.frontend.8": "Vue.js (em aprendizagem)",
    "about.technical.design.title": "UI/UX",
    ...
    "courses.intro": "Formação recente organizada por trilhos de aprendizagem: QA, fundamentos web, programação, Java, bases de dados, engenharia de software e projetos.",
    ...
    "courses.5": "Fundamentos de Programação: Programação em C/C++ - fundamentos - IEFP Certification (Jun 2026)",
    "courses.6": "Desenvolvimento Java: Programação em Java - IEFP Certification (Mar 2026)",
    "courses.7": "Desenvolvimento Java: Fundamentos de linguagem JAVA - IEFP Certification (Mai 2026)",
    "courses.8": "Desenvolvimento Java: Desenvolvimento de aplicações web em JAVA - IEFP Certification (Jul 2026)",
    "courses.9": "Bases de Dados: Fundamentos da linguagem SQL - IEFP Certification (Mar 2026)",
    "courses.10": "Bases de Dados: Tecnologias de acesso a base de dados - IEFP Certification (Abr 2026)",
    "courses.11": "Engenharia de Software: Engenharia de software - IEFP Certification (Jun 2026)",
    "courses.12": "Engenharia de Software: Metodologias de desenvolvimento de software - IEFP Certification (Jun 2026)",
    "courses.13": "Projetos: Projeto de programação - IEFP Certification (Jul 2026)",
    "courses.14": "Projetos: Projeto de tecnologias e programação de sistemas de informação - IEFP Certification (Jul 2026)",
