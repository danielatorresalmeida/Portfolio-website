...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "hero.lead": "Frontend Developer turning product goals into accessible, responsive web experiences with React, TypeScript, UI/UX design, and QA.",
    ...
    "strengths.0": "Frontend engineering across HTML, CSS, JavaScript, React, TypeScript, and Next.js to deliver responsive interfaces.",
    "strengths.1": "UI/UX execution from Figma into accessible, component-based user experiences.",
    "strengths.2": "Quality assurance and testing through manual QA, API validation, Selenium checks, and Pytest reporting.",
    ...
    "strengths.4": "Java and backend development using Java fundamentals, Java web application development, Python, and FastAPI.",
    "strengths.5": "Software engineering foundations with algorithms, C/C++ fundamentals, development methodologies, and project delivery workflows.",
  ...
  [LANG_PT]: {
    ...
    "hero.lead": "Frontend Developer que transforma objetivos de produto em experiências web acessíveis e responsivas com React, TypeScript, design UI/UX e QA.",
    ...
    "strengths.0": "Engenharia frontend com HTML, CSS, JavaScript, React, TypeScript e Next.js para entregar interfaces responsivas.",
    "strengths.1": "Execução de UI/UX de Figma para experiências acessíveis e baseadas em componentes.",
    "strengths.2": "QA e testes com validação manual, testes de API, verificações com Selenium e relatórios com Pytest.",
    "strengths.3": "Engenharia de dados e bases de dados com fundamentos de SQL, tecnologias de acesso a base de dados, modelação relacional e PostgreSQL.",
    "strengths.4": "Desenvolvimento Java e backend com fundamentos de Java, desenvolvimento web em Java, Python e FastAPI.",
    "strengths.5": "Fundamentos de engenharia de software com algoritmos, fundamentos de C/C++, metodologias de desenvolvimento e fluxos de entrega de projetos.",
