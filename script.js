...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "projects.intro": "Four focused projects that highlight production frontend delivery, QA automation, and independent React development.",
    ...
    "projects.caipo.overlay": "Next.js product website positioning CAIPO wearable and Dev Kit paths with clear conversion flow.",
    "projects.caipo.title": "CAIPO.ai",
    "projects.caipo.summary": "Production-facing React/Next.js project presenting both consumer and builder product journeys.",
    "projects.caipo.what": "What I did: Built and refined responsive frontend sections to communicate CAIPO's wearable and developer-kit offerings with clearer hierarchy and CTA clarity.",
    "projects.caipo.problem": "<strong>Problem:</strong> The site needed to explain two distinct product paths without losing clarity.",
    "projects.caipo.solution": "<strong>Solution:</strong> Structured responsive sections and messaging to guide users toward either wearable or Dev Kit decisions.",
    "projects.caipo.outcome": "<strong>Outcome:</strong> Delivered a cleaner product narrative and stronger conversion-oriented browsing flow.",
    "projects.caipo.proof": "Stack: Next.js, React, Tailwind CSS, Vercel.",
    "projects.caipo.description": "Tech used on the live site: Next.js (React), Tailwind CSS, and Vercel hosting.",
    ...
    "courses.5": "Programming Foundations: C/C++ Programming - Fundamentals (Jun 2026)",
    "courses.6": "Java Development: Java Programming (Mar 2026)",
    "courses.7": "Java Development: Java Language Fundamentals (May 2026)",
    "courses.8": "Java Development: Web Application Development in Java (Jul 2026)",
    "courses.9": "Databases: SQL Language Fundamentals (Mar 2026)",
    "courses.10": "Databases: Database Access Technologies (Apr 2026)",
    "courses.11": "Software Engineering: Software Engineering (Jun 2026)",
    "courses.12": "Software Engineering: Software Development Methodologies (Jun 2026)",
    "courses.13": "Projects: Programming Project (Jul 2026)",
    "courses.14": "Projects: Information Systems Technologies and Programming Project (Jul 2026)",
  ...
  [LANG_PT]: {
    ...
    "projects.intro": "Quatro projetos focados que mostram entrega frontend em producao, automacao de QA e desenvolvimento React independente.",
    ...
    "projects.caipo.overlay": "Website de produto em Next.js que posiciona o wearable CAIPO e o Dev Kit com fluxo de conversao claro.",
    "projects.caipo.title": "CAIPO.ai",
    "projects.caipo.summary": "Projeto React/Next.js em producao que apresenta jornadas de produto para consumidor final e builders.",
    "projects.caipo.what": "O que fiz: Construí e refinei secoes frontend responsivas para comunicar as ofertas wearable e developer kit da CAIPO com hierarquia mais clara e CTAs mais diretos.",
    "projects.caipo.problem": "<strong>Problema:</strong> O site precisava explicar dois caminhos de produto distintos sem perder clareza.",
    "projects.caipo.solution": "<strong>Solucao:</strong> Estruturei secoes responsivas e mensagens para guiar utilizadores para a opcao wearable ou Dev Kit.",
    "projects.caipo.outcome": "<strong>Resultado:</strong> Entreguei uma narrativa de produto mais clara e um fluxo de navegacao mais orientado a conversao.",
    "projects.caipo.proof": "Stack: Next.js, React, Tailwind CSS, Vercel.",
    "projects.caipo.description": "Tecnologias usadas no site atual: Next.js (React), Tailwind CSS e alojamento na Vercel.",
    ...
    "courses.5": "Fundamentos de Programação: Programação em C/C++ - fundamentos (Jun 2026)",
    "courses.6": "Desenvolvimento Java: Programação em Java (Mar 2026)",
    "courses.7": "Desenvolvimento Java: Fundamentos de linguagem JAVA (Mai 2026)",
    "courses.8": "Desenvolvimento Java: Desenvolvimento de aplicações web em JAVA (Jul 2026)",
    "courses.9": "Bases de Dados: Fundamentos da linguagem SQL (Mar 2026)",
    "courses.10": "Bases de Dados: Tecnologias de acesso a base de dados (Abr 2026)",
    "courses.11": "Engenharia de Software: Engenharia de software (Jun 2026)",
    "courses.12": "Engenharia de Software: Metodologias de desenvolvimento de software (Jun 2026)",
    "courses.13": "Projetos: Projeto de programação (Jul 2026)",
    "courses.14": "Projetos: Projeto de tecnologias e programação de sistemas de informação (Jul 2026)",
