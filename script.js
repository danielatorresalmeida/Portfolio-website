...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "projects.penguinFishing.overlay": "Arcade fishing gameplay with keyboard controls, timed rounds, and local multiplayer.",
    "projects.penguinFishing.status": "Browser game",
    "projects.penguinFishing.title": "Penguin Fishing Game",
    "projects.penguinFishing.summary": "Fast-paced fishing game with multiple modes, configurable players, and sound controls.",
    "projects.penguinFishing.what": "A browser-based arcade game where players move penguins, rotate fishing hooks, and compete to catch the most fish before time runs out.",
    "projects.penguinFishing.mainTool": "<strong>Main tool:</strong> JavaScript",
    "projects.penguinFishing.secondary": "<strong>Also uses:</strong> HTML, CSS, keyboard input, timers, and sound.",
    "projects.penguinFishing.demonstrates": "<strong>What it demonstrates:</strong> Interactive game-state logic, responsive controls, scoring, and local multiplayer design.",
    "projects.penguinFishing.features": "<strong>Main features:</strong> Multiple game modes, one- or two-player matches, timed rounds, scoring rules, pause, restart, and sound controls.",
    "projects.penguinFishing.learning": "<strong>Tech stack:</strong> HTML, CSS, JavaScript, Replit.",
    "projects.penguinFishing.proof": "Tech stack: HTML, CSS, JavaScript, Replit.",
  ...
  [LANG_PT]: {
    ...
    "projects.penguinFishing.overlay": "Jogo de pesca arcade com controlos de teclado, rondas cronometradas e multijogador local.",
    "projects.penguinFishing.status": "Jogo de browser",
    "projects.penguinFishing.title": "Penguin Fishing Game",
    "projects.penguinFishing.summary": "Jogo de pesca dinamico com varios modos, numero de jogadores configuravel e controlo de som.",
    "projects.penguinFishing.what": "Um jogo arcade de browser onde os jogadores movem pinguins, rodam anzois e competem para apanhar mais peixes antes de o tempo terminar.",
    "projects.penguinFishing.mainTool": "<strong>Ferramenta principal:</strong> JavaScript",
    "projects.penguinFishing.secondary": "<strong>Tambem usa:</strong> HTML, CSS, input de teclado, temporizadores e som.",
    "projects.penguinFishing.demonstrates": "<strong>O que demonstra:</strong> Logica interativa de estado do jogo, controlos responsivos, pontuacao e design multijogador local.",
    "projects.penguinFishing.features": "<strong>Funcionalidades principais:</strong> Varios modos de jogo, partidas para um ou dois jogadores, rondas cronometradas, regras de pontuacao, pausa, reinicio e controlo de som.",
    "projects.penguinFishing.learning": "<strong>Stack:</strong> HTML, CSS, JavaScript, Replit.",
    "projects.penguinFishing.proof": "Stack: HTML, CSS, JavaScript, Replit.",
