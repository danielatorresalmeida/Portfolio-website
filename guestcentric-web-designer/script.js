...
const TRANSLATIONS = {
  [LANG_EN]: {
    ...
    "hero.title": "UI/UX & Frontend-Focused <span class=\"accent\">Web Designer</span>",
    "hero.lead": "I design clean, responsive web experiences in Figma and bring them closer to production with HTML, CSS, and frontend thinking. I focus on clarity, usability, and layouts that work across real devices.",
    "hero.cta.work": "View Selected Projects",
    "hero.cta.resume": "Download CV",
    "hero.cta.contact": "Contact Me",
    "hero.highlights.0.title": "Design to browser",
    "hero.highlights.0.text": "From Figma structure to HTML/CSS implementation with responsive behavior in mind.",
    "hero.highlights.1.title": "User-centered layout",
    "hero.highlights.1.text": "I prioritize visual hierarchy, clear calls to action, and friction-reduced user journeys.",
    "hero.highlights.2.title": "Junior and practical",
    "hero.highlights.2.text": "I am junior-level, hands-on, and continuously improving through real UI, frontend, and QA project work.",
    "coreStack.heading": "Core Skills For Web Design + Frontend Delivery",
    "coreStack.note": "Guestcentric-focused profile: design quality, responsive structure, and browser-ready implementation.",
    ...
    "projects.intro": "UI/UX and frontend projects selected for Guestcentric: structure, responsive behavior, implementation feasibility, and practical delivery.",
    "projects.featured.eyebrow": "Featured case study",
    ...
    "projects.nextpath.status": "Featured case study (in progress)",
    ...
    "courses.6": "Java Development: Java Language Fundamentals (May 2026)",
    "courses.7": "Databases: SQL Language Fundamentals (Mar 2026)",
    "courses.8": "Databases: Database Access Technologies (Apr 2026)",
    ...
    "contact.intro": "I'm open to UI/UX, Web Design, and frontend-focused opportunities where design decisions need to work in the browser.",
  ...
  [LANG_PT]: {
    ...
    "hero.title": "Web Designer <span class=\"accent\">focada em UI/UX e Frontend</span>",
    "hero.lead": "Desenho experiencias web limpas e responsivas em Figma e aproximo-as da producao com HTML, CSS e pensamento frontend. Foco-me em clareza, usabilidade e layouts que funcionam em dispositivos reais.",
    "hero.cta.work": "Ver projetos selecionados",
    "hero.cta.resume": "Descarregar CV",
    "hero.cta.contact": "Contactar",
    "hero.highlights.0.title": "Do design ao browser",
    "hero.highlights.0.text": "Da estrutura em Figma a implementacao em HTML/CSS com comportamento responsivo em mente.",
    "hero.highlights.1.title": "Layout centrado no utilizador",
    "hero.highlights.1.text": "Priorizo hierarquia visual, calls to action claros e jornadas com menos friccao.",
    "hero.highlights.2.title": "Junior e pratica",
    "hero.highlights.2.text": "Sou junior, hands-on, e continuo a evoluir com projetos reais de UI, frontend e QA.",
    "coreStack.heading": "Competencias-Chave para Web Design + Entrega Frontend",
    "coreStack.note": "Perfil focado para a Guestcentric: qualidade de design, estrutura responsiva e implementacao pronta para browser.",
    "coreStack.frontend.title": "Frontend",
    "coreStack.frontend.0": "HTML",
    "coreStack.frontend.1": "CSS",
    "coreStack.frontend.2": "JavaScript",
    ...
    "projects.intro": "Projetos de UI/UX e frontend selecionados para a Guestcentric: estrutura, comportamento responsivo, viabilidade de implementacao e entrega pratica.",
    "projects.featured.eyebrow": "Caso de estudo em destaque",
    "projects.featured.title": "NextPath Angular Dashboard",
    ...
    "projects.nextpath.status": "Caso de estudo em destaque (em progresso)",
    "projects.nextpath.title": "NextPath Angular Dashboard",
    ...
    "courses.6": "Desenvolvimento Java: Fundamentos de linguagem JAVA (Mai 2026)",
    "courses.7": "Bases de Dados: Fundamentos da linguagem SQL (Mar 2026)",
    "courses.8": "Bases de Dados: Tecnologias de acesso a base de dados (Abr 2026)",
    ...
    "contact.intro": "Estou aberta a oportunidades de UI/UX, Web Design e frontend onde as decisoes de design tenham de funcionar no browser.",
    "contact.actions.email": "Email",
    "contact.actions.linkedin": "LinkedIn",
