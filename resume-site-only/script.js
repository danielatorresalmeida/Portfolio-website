...
const translations = {
  [LANG_EN]: {
    ...
    courses: [
      ...
      "Programming Foundations: Programação - Algoritmos (Abr 2026)",
      "Programming Foundations: Programação em C/C++ - fundamentos (Jun 2026)",
      "Java Development: Java Programming (Mar 2026)",
      "Java Development: Fundamentos de linguagem JAVA (Mai 2026)",
      "Java Development: Desenvolvimento de aplicações web em JAVA (Jul 2026)",
      "Databases: Fundamentos da linguagem SQL (Mar 2026)",
      "Databases: Tecnologias de acesso a base de dados (Abr 2026)",
      "Software Engineering: Engenharia de software (Jun 2026)",
      "Software Engineering: Metodologias de desenvolvimento de software (Jun 2026)",
      "Projects: Projeto de programação (Jul 2026)",
      "Projects: Projeto de tecnologias e programação de sistemas de informação (Jul 2026)",
    ],
  ...
  [LANG_PT]: {
    ...
    courses: [
      "QA e Testes: Fundamentals of Quality Assurance Engineer - Udemy (Jul 2025)",
      "QA e Testes: Foundations of Software Testing and Validation - University of Leeds (Jul 2025)",
      "Fundamentos Web: Conceção de websites (Fev 2026)",
      "Fundamentos de Programação: Python Software Language - Programming Hub (Ago 2025)",
