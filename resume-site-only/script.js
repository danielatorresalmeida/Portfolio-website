...
const translations = {
  [LANG_EN]: {
    ...
    experienceItems: [
      {
        ...
        bullets: [
          ...
          "Reduced bug turnaround time by ~20% through structured QA testing and improved bug-tracking workflows.",
        ],
      },
      {
    ...
    skillGroups: [
      ...
      },
      {
        ...
        items: ["Java", "Python", "SQL / Database Design", "PostgreSQL", "IntelliJ IDEA", "Eclipse"],
      },
    ],
  ...
  [LANG_PT]: {
    ...
    skillGroups: [
      ...
      {
        title: "Backend e Ferramentas",
        items: ["Java", "Python", "SQL / Design de Base de Dados", "PostgreSQL", "IntelliJ IDEA", "Eclipse"],
      },
    ],
