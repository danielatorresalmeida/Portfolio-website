...
const META_LINE_HTML = `Cascais, Portugal &middot; <button class="meta-link contact-reveal contact-reveal--inline" type="button" data-contact-reveal="email" aria-label="Reveal email address">Reveal email</button> &middot; <button class="meta-link meta-whatsapp contact-reveal contact-reveal--inline" type="button" data-contact-reveal="whatsapp" aria-label="Reveal WhatsApp number">${WHATSAPP_ICON}<span data-contact-value>Reveal WhatsApp</span></button> &middot; <a class="meta-link meta-linkedin" href="https://www.linkedin.com/in/daniela-torres-almeida-945884205/" target="_blank" rel="noopener">${LINKEDIN_ICON}<span>LinkedIn</span></a> &middot; <a class="meta-link" href="https://github.com/danielatorresalmeida" target="_blank" rel="noopener">github.com/danielatorresalmeida</a>`;
...
const translations = {
  [LANG_EN]: {
    ...
    courses: [
      ...
      "Web Foundations: Website Design - IEFP Certification (Feb 2026)",
      "Programming Foundations: Python Software Language - Programming Hub (Aug 2025)",
      "Programming Foundations: Programming - Algorithms - IEFP Certification (Apr 2026)",
      "Programming Foundations: C/C++ Programming - Fundamentals - IEFP Certification (Jun 2026)",
      "Java Development: Java Programming - IEFP Certification (Mar 2026)",
      "Java Development: Java Language Fundamentals - IEFP Certification (May 2026)",
      "Java Development: Web Application Development in Java - IEFP Certification (Jul 2026)",
      "Databases: SQL Language Fundamentals - IEFP Certification (Mar 2026)",
      "Databases: Database Access Technologies - IEFP Certification (Apr 2026)",
      "Software Engineering: Software Engineering - IEFP Certification (Jun 2026)",
      "Software Engineering: Software Development Methodologies - IEFP Certification (Jun 2026)",
      "Projects: Programming Project - IEFP Certification (Jul 2026)",
      "Projects: Information Systems Technologies and Programming Project - IEFP Certification (Jul 2026)",
    ],
  ...
  [LANG_PT]: {
    ...
    courses: [
      ...
      "Fundamentos Web: Conceção de websites - IEFP Certification (Fev 2026)",
      "Fundamentos de Programação: Linguagem de Programação Python - Programming Hub (Ago 2025)",
      "Fundamentos de Programação: Programação - Algoritmos - IEFP Certification (Abr 2026)",
      "Fundamentos de Programação: Programação em C/C++ - fundamentos - IEFP Certification (Jun 2026)",
      "Desenvolvimento Java: Programação em Java - IEFP Certification (Mar 2026)",
      "Desenvolvimento Java: Fundamentos de linguagem JAVA - IEFP Certification (Mai 2026)",
      "Desenvolvimento Java: Desenvolvimento de aplicações web em JAVA - IEFP Certification (Jul 2026)",
      "Bases de Dados: Fundamentos da linguagem SQL - IEFP Certification (Mar 2026)",
      "Bases de Dados: Tecnologias de acesso a base de dados - IEFP Certification (Abr 2026)",
      "Engenharia de Software: Engenharia de software - IEFP Certification (Jun 2026)",
      "Engenharia de Software: Metodologias de desenvolvimento de software - IEFP Certification (Jun 2026)",
      "Projetos: Projeto de programação - IEFP Certification (Jul 2026)",
      "Projetos: Projeto de tecnologias e programação de sistemas de informação - IEFP Certification (Jul 2026)",
    ],
    ...
    strengths: [
      "<strong>Engenharia Frontend</strong> - entregar interfaces acessíveis e responsivas com HTML, CSS, JavaScript, React, TypeScript e Next.js.",
      "<strong>Execução de UI/UX</strong> - levar ideias de produto de Figma para produção através de experiências acessíveis e baseadas em componentes.",
      "<strong>QA e Testes</strong> - reduzir regressões com QA manual, validação de API, verificações com Selenium e relatórios com Pytest.",
      "<strong>Engenharia de Dados e Bases de Dados</strong> - aplicar fundamentos de SQL, tecnologias de acesso a base de dados, modelação relacional e PostgreSQL.",
...
// Translation fallback order: selected language -> English -> empty string.
function t(key) {
...
// Small null-safe text setter for DOM nodes.
function setText(node, value) {
  if (node) node.textContent = value;
}

// Small null-safe HTML setter for DOM nodes.
function setHTML(node, value) {
  if (node) node.innerHTML = value;
}

// Guard against missing/invalid translation arrays.
function asArray(value) {
  return Array.isArray(value) ? value : [];
}

// Warn in dev tools when DOM placeholders and translation data get out of sync.
...
// Update theme button visuals/labels to match current mode.
...
// Render all translated resume sections from the current language map.
...
// Apply language, labels, and section content in one pass.
...
// Wait briefly for project images so print exports include loaded thumbnails.
...
// Print after image loading settles (or timeout), for more reliable output.
