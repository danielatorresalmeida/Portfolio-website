...
put('hero.lead', 'I build web interfaces and APIs with React, TypeScript and Java/Spring Boot, drawing on practical startup experience and completed Java training.', 'Desenvolvo interfaces web e APIs com React, TypeScript e Java/Spring Boot, com experiência prática numa startup e formação de Java concluída.');
...
put('hero.highlights.1.title', 'Current training', 'Formação atual');
put('hero.highlights.1.text', 'CESAE Digital · Software Developer · 22 September 2026 - 20 May 2027.', 'CESAE Digital · Software Developer · 22 de setembro de 2026 - 20 de maio de 2027.');
put('hero.highlights.2.title', 'Next step · 2027', 'Próxima etapa · 2027');
put('hero.highlights.2.text', '400-hour curricular internship, scheduled 1 March - 20 May, with interest in continuing as a Junior Developer.', 'Estágio curricular de 400 horas, previsto para 1 de março - 20 de maio, com interesse em continuidade como Junior Developer.');
...
put('contact.intro', 'Let’s discuss a 400-hour Software Development curricular internship scheduled for 1 March - 20 May 2027, and the possibility of continuing as a Junior Developer if it is a good fit for both sides.', 'Podemos conversar sobre um estágio curricular de 400 horas em Software Development, com início previsto para 1 de março - 20 de maio de 2027, e sobre a possibilidade de continuidade como Junior Developer se houver interesse mútuo.');

const title = 'Daniela Torres Almeida | Software Developer / Front-End Developer';
const description = 'Software Developer in training in Cascais, Portugal. React/TypeScript, Java/Spring Boot and APIs. Seeking a 400-hour curricular internship from 1 March to 20 May 2027.';
doc.title = title;
